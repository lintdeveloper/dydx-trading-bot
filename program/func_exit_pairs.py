...
def manage_trade_exits(client):
  ...
  for position in open_positions_dict:
    ...
    if is_close:
      ...
      accept_price_m1 = convert_to_step_size(accept_price_m1, tick_size_m1)
      accept_price_m2 = convert_to_step_size(accept_price_m2, tick_size_m2)
